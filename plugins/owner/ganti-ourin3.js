...
const pluginConfig = {
    ...
    category: 'owner',
    description: "Cambiar la imagen ourin3.",
    usage: ".gantiourin3 (responde o envía una imagen)",
...
async function handler(m, { sock }) {
    ...
    if (!isImage) {
        return m.reply(`🖼️ *sustituye ourin3.jpg*
...
La imagen ourin3.jpg ha sido cambiada`)
